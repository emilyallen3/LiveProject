...
def magic_details(request, pk):
    ...
    return render(request, 'magic_details.html', content)
...
def magic_edit(request, pk):
    ...
    return render(request, 'magic_edit.html', content)
...
def magic_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('../../browse')
    content = {'deck': deck}
    return render(request, 'magic_delete.html', content)
...
def magic_api(request):
    return render(request, 'magic_api.html')
...
def card_search(request):
    if request.method == 'POST':
        ...
        return render(request, 'card_search.html', content)
